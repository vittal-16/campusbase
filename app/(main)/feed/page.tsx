...
export default function FeedPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b px-4 py-4 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
          <h1 className="text-xl font-bold text-gray-800 whitespace-nowrap">CampusBase</h1>
  ...
  <button
    ...
    className="bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-lg font-medium hover:bg-gray-200 transition"
  >
    My Listings
  </button>
  <button
